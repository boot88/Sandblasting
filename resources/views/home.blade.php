...
<body>
    ...
    <div class="mobile-actions" aria-label="Быстрая связь">
        ...
        <a class="mobile-actions__primary" href="#leadPhoto" onclick="event.preventDefault(); event.stopImmediatePropagation(); document.getElementById('leadPhoto')?.click(); return false;">Оценить по фото</a>
    </div>
