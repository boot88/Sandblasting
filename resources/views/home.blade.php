                ...
                <div class="contact-layout">
                    ...
                    <div class="quote-card" id="quote">
                        ...
                        <form id="leadForm" method="POST" action="{{ route('lead.send') }}" enctype="multipart/form-data" novalidate>
                            ...
                            <label class="upload-field" for="leadPhoto"><span class="upload-field__icon" aria-hidden="true">+</span><span><strong>Прикрепить фото детали</strong><small>JPG, PNG, WebP, HEIC или AVIF · до 5 МБ · большие фото уменьшаются автоматически</small></span><input id="leadPhoto" type="file" name="photo" accept="image/jpeg,image/png,image/webp,image/heic,image/heif,image/avif"><em id="photoStatus">Фото не выбрано</em></label>
