...
/* Иконка/знак для мобильной шапки */
.brand-mark{
  width: 40px;
  height: 40px;
  object-fit: contain;
...
@media (min-width: 768px){ .brand-mark{ width: 44px; height: 44px; } }

/* Картинки услуг — одинаковая геометрия */
.service-img{
  width: 100%;
  aspect-ratio: 3 / 2;
  height: auto;
...
.service-card:hover .service-img{
  ...
  outline-color: rgba(235,134,16,.35);
}
.service-card:hover .service-title{ color: var(--brand-accent); }
@media (max-width: 360px){ .service-img{ border-radius: 12px; } }
/* Якоря: чтобы секции не прятались под фикс-шапкой */
...
<script type="text/javascript">
    ...
    })(window, document,'script','https://mc.yandex.ru/metrika/tag.js?id=106844100', 'ym');

    ym(106844100, 'init', {ssr:true, webvisor:true, clickmap:true, ecommerce:"dataLayer", referrer: document.referrer, url: location.href, accurateTrackBounce:true, trackLinks:true});
</script>
<noscript><div><img src="https://mc.yandex.ru/watch/106844100" style="position:absolute; left:-9999px;" alt="" /></div></noscript>
<!-- /Yandex.Metrika counter -->
        ...
        <nav class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex justify-between items-center h-16 md:h-20">
                ...
                <div class="flex-shrink-0 flex items-center gap-2">
                    <img src="http://nioch-appl.ru/Sandblasting/public/images/logotip/l-m.jpg" alt="SandBlast Polymer" class="brand-mark md:hidden">
                    <img src="http://nioch-appl.ru/Sandblasting/public/images/logotip/l-w.jpg" alt="Логотип SandBlast Polymer" class="brand-logo hidden md:block">
                    <span class="text-2xl font-bold text-primary-600 ml-1 hidden md:inline">ООО "SandBlast Polymer"</span>
                </div>
                ...
                <div class="hidden md:block">
                    <div class="ml-10 flex items-baseline space-x-6">
                        ...
                        <a href="#about" class="text-neutral-700 hover:text-primary-500 px-3 py-2 text-sm font-medium">Работы</a>
            ...
            <div id="mobile-menu" class="md:hidden hidden">
                <div class="px-2 pt-2 pb-3 space-y-1 sm:px-3 bg-white border-t">
                    ...
                    <a href="#about" class="block px-3 py-2 text-base font-medium text-neutral-700 hover:text-primary-500">Работы</a>
